...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	  <center><h3>Children Watches</h3></center>
    <?php
    $sql="select * from product where CatId=3 and subcatId=3 ";
    ...
    //echo $image;
	  echo "<td><table><tr>";
	  echo "<td><a href=watchproduct.php?id3=".$row2['ProductId']."><img src=".$image." width=200 height=300/></a></td></tr>";
