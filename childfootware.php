...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	  <center><h3>Children Footware</h3></center>
          <?php
          $sql="select * from product where CatId=3 and subcatId=2 ";
        ...
        $image=$target_path1.$row2['ProductImage'];
          //echo $image;
        echo "<td><table><tr>";
        echo "<td><a href=footwareproduct.php?id3=".$row2['ProductId']."><img src=".$image." width=200 height=300/></a></td></tr>";
