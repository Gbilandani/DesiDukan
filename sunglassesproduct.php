...
if(isset($_POST['addcart']))
{
  ...
  $q2="INSERT INTO cart(email, productid, image, productname,  quantity, price) 
      VALUES ('$email','$pid','$image','$pname','$quan','$price')  ";
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	  <center><h3>Sunglasses</h3></center>
      <form method='post'>
    ...
    <tr> 
	  ...
	  <center> <table border="0">
        <tr><span>
          <td><div style="color:#666;font-size:16px;">Description </div></td>
          <td><center>
...
*/
         ...
         <tr><td colspan="2">
		<center>
		<input type="submit" value="AddToCart" name='addcart'/></center>
             </td></tr>
    </form>
          </table></center></td>
      <!--  <td width="311">&nbsp;</td> 
